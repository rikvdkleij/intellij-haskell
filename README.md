...
- Plugin will automatically build [haskell-tools](https://github.com/haskell-tools/haskell-tools) if you use Stack resolver later than `nightly-2017-01-14` or `lts-8.0`.
