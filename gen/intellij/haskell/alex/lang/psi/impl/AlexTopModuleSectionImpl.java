...
public class AlexTopModuleSectionImpl extends AlexHaskellCodeInjectionHost implements AlexTopModuleSection {

  public AlexTopModuleSectionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlexVisitor visitor) {
    visitor.visitTopModuleSection(this);
  }
