...
public class HaskellParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // (("forall" | FORALL) ((onl q_name+ onl LEFT_PAREN onl (type_signature | ttype) onl (COMMA onl (type_signature | ttype))* onl RIGHT_PAREN)+ | onl type_signature | onl q_name+) (onl DOUBLE_RIGHT_ARROW onl ttype)? |
  ...
  // (onl q_name+ onl LEFT_PAREN onl (type_signature | ttype) onl (COMMA onl (type_signature | ttype))* onl RIGHT_PAREN)+ | onl type_signature | onl q_name+
  ...
  // onl q_name+
  private static boolean atype_0_0_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_0_0_1_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = onl(b, l + 1);
    r = r && atype_0_0_1_2_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // q_name+
  private static boolean atype_0_0_1_2_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_0_0_1_2_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = q_name(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!q_name(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "atype_0_0_1_2_1", c)) break;
    }
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // import_declarations top_declarations  (NEWLINE | DIRECTIVE | INCLUDE_DIRECTIVE)*
  ...
  // (NEWLINE | DIRECTIVE | INCLUDE_DIRECTIVE)*
  ...
  /* ********************************************************** */
  // ((pragma | INCLUDE_DIRECTIVE | DIRECTIVE) NEWLINE*)*
  ...
  // NEWLINE*
  private static boolean file_header_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "file_header_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!consumeToken(b, HS_NEWLINE)) break;
      if (!empty_element_parsed_guard_(b, "file_header_0_1", c)) break;
    }
    return true;
  }
  ...
  public static boolean import_declaration(PsiBuilder b, int l) {
    ...
    r = p && import_declaration_7(b, l + 1) && r;
  ...
  /* ********************************************************** */
  // ((import_declaration | pragma | INCLUDE_DIRECTIVE | DIRECTIVE) onl)*
  ...
  // import_declaration | pragma | INCLUDE_DIRECTIVE | DIRECTIVE
  ...
  /* ********************************************************** */
  // (&<<containsSpaces>> NEWLINE | DIRECTIVE NEWLINE !keyword | pragma NEWLINE)*
  ...
  /* ********************************************************** */
  // (top_declaration_line (NEWLINE | INCLUDE_DIRECTIVE | DIRECTIVE)*)* top_declaration?
  ...
  // (top_declaration_line (NEWLINE | INCLUDE_DIRECTIVE | DIRECTIVE)*)*
  ...
  // (NEWLINE | INCLUDE_DIRECTIVE | DIRECTIVE)*
