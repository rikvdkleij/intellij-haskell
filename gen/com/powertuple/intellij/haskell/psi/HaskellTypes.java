...
import com.powertuple.intellij.haskell.psi.impl.*;
...
public interface HaskellTypes {
  ...
  IElementType HS_QVAR_DOT_SYM = new HaskellCompositeElementType("HS_QVAR_DOT_SYM");
  ...
  IElementType HS_TYPE_SIGNATURE_DECLARATION = new HaskellCompositeElementType("HS_TYPE_SIGNATURE_DECLARATION");
  ...
  IElementType HS_VAR_DOT_SYM = new HaskellCompositeElementType("HS_VAR_DOT_SYM");
  ...
  IElementType HS_QUASI_QUOTE_D_START = new HaskellTokenType("QUASI_QUOTE_D_START");
  IElementType HS_QUASI_QUOTE_END = new HaskellTokenType("QUASI_QUOTE_END");
  IElementType HS_QUASI_QUOTE_E_START = new HaskellTokenType("QUASI_QUOTE_E_START");
  IElementType HS_QUASI_QUOTE_P_START = new HaskellTokenType("QUASI_QUOTE_P_START");
  IElementType HS_QUASI_QUOTE_T_START = new HaskellTokenType("QUASI_QUOTE_T_START");
  IElementType HS_QUASI_QUOTE_V_START = new HaskellTokenType("QUASI_QUOTE_V_START");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == HS_QVAR_DOT_SYM) {
        return new HaskellQvarDotSymImpl(node);
      }
      ...
      else if (type == HS_TYPE_SIGNATURE_DECLARATION) {
        return new HaskellTypeSignatureDeclarationImpl(node);
      }
      ...
      else if (type == HS_VAR_DOT_SYM) {
        return new HaskellVarDotSymImpl(node);
      }
