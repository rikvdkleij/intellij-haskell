...
public class HaskellLastLineExpressionImpl extends HaskellLineExpressionElementImpl implements HaskellLastLineExpression {

  public HaskellLastLineExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HaskellVisitor) ((HaskellVisitor)visitor).visitLastLineExpression(this);
