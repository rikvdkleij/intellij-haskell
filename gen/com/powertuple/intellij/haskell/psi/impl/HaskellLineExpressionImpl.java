...
public class HaskellLineExpressionImpl extends HaskellLineExpressionElementImpl implements HaskellLineExpression {

  public HaskellLineExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HaskellVisitor) ((HaskellVisitor)visitor).visitLineExpression(this);
