...
public class HaskellVarDotSymImpl extends HaskellNamedElementImpl implements HaskellVarDotSym {

  public HaskellVarDotSymImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HaskellVisitor) ((HaskellVisitor)visitor).visitVarDotSym(this);
