...
object HaskellParserDefinition {
  ...
  final val RESERVED_IDS: TokenSet = TokenSet.create(HS_CASE, HS_CLASS, HS_DATA, HS_DEFAULT, HS_DERIVING, HS_DO, HS_ELSE, HS_FORALL, HS_IF, HS_IMPORT,
    HS_IN, HS_INFIX, HS_INFIXL, HS_INFIXR, HS_INSTANCE, HS_LET, HS_MODULE, HS_NEWTYPE, HS_OF, HS_THEN, HS_TYPE, HS_UNSAFE, HS_WHERE, HS_UNDERSCORE)
  ...
  final val RESERVED_OPERATORS: TokenSet = TokenSet.create(HS_DOT_DOT, HS_COLON, HS_COLON_COLON, HS_EQUAL, HS_BACKSLASH, HS_VERTICAL_BAR, HS_LEFT_ARROW,
    HS_RIGHT_ARROW, HS_AT, HS_TILDE, HS_DOUBLE_RIGHT_ARROW)
  final val OPERATORS: TokenSet = TokenSet.orSet(RESERVED_OPERATORS, TokenSet.create(HS_QVAROP_ID,  HS_QCONOP_ID))
  final val NUMBERS = TokenSet.create(HS_DECIMAL, HS_FLOAT, HS_HEXADECIMAL, HS_OCTAL)
  final val SYMBOLS = TokenSet.create(HS_EXCLAMATION_MARK, HS_HASH, HS_DOLLAR, HS_PERCENTAGE, HS_AMPERSAND, HS_STAR, HS_PLUS, HS_DOT, HS_SLASH, HS_LT,
    HS_EQUAL, HS_GT, HS_QUESTION_MARK, HS_AT, HS_BACKSLASH, HS_CARET, HS_VERTICAL_BAR, HS_TILDE, HS_DASH)  // except colon
}
