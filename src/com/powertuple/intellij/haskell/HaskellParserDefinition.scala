...
object HaskellParserDefinition {
  ...
  final val RESERVED_IDS: TokenSet = TokenSet.create(HS_CASE, HS_CLASS, HS_DATA, HS_DEFAULT, HS_DERIVING, HS_DO, HS_ELSE, HS_FOREIGN, HS_IF, HS_IMPORT, HS_IN, HS_INFIX, HS_INFIXL, HS_INFIXR, HS_INSTANCE, HS_LET, HS_MODULE, HS_NEWTYPE, HS_OF, HS_THEN, HS_TYPE, HS_WHERE, HS_UNDERSCORE, HS_AS, HS_QUALIFIED, HS_HIDING, HS_INCLUDE)
  final val OPERATORS: TokenSet = TokenSet.create(HS_DOT_DOT, HS_COLON, HS_COLON_COLON, HS_EQUAL, HS_SLASH, HS_VERTICAL_BAR, HS_LEFT_ARROW, HS_RIGHT_ARROW, HS_AT, HS_TILDE, HS_DOUBLE_RIGHT_ARROW, HS_QVARSYM, HS_VARSYM, HS_QCONSYM, HS_CONSYM)
}
