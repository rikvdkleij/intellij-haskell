...
object HaskellParserDefinition {
  ...
  final val RESERVED_OPERATORS: TokenSet = TokenSet.create(HS_COLON_COLON, HS_EQUAL, HS_BACKSLASH, HS_VERTICAL_BAR, HS_LEFT_ARROW,
    HS_RIGHT_ARROW, HS_AT, HS_TILDE, HS_DOUBLE_RIGHT_ARROW)
  final val OPERATORS: TokenSet = TokenSet.orSet(RESERVED_OPERATORS, TokenSet.create(HS_QVARSYM_ID,  HS_GCONSYM_ID))
