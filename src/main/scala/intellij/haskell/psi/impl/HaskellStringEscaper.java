...
public class HaskellStringEscaper extends LiteralTextEscaper<HaskellStringLiteralElementImpl> {
    private int[] outSourceOffsets;

    public HaskellStringEscaper(HaskellStringLiteralElementImpl host) {
        super(host);
    }
    ...
    public static boolean parseStringCharacters(String chars,
