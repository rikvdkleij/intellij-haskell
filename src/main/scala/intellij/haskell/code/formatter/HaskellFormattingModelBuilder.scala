...
package intellij.haskell.code.formatter
...
import intellij.haskell.code.formatter.settings.HaskellCodeStyleSettings
import intellij.haskell.psi.HaskellTypes._
import intellij.haskell.{HaskellLanguage, HaskellParserDefinition}
