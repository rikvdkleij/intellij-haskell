...
class BuildHoogleDbAction extends AnAction {
  ...
  override def update(actionEvent: AnActionEvent) {
    HaskellEditorUtil.enableExternalAction(actionEvent, (project: Project) => !StackProjectManager.isStarting(project) && StackProjectManager.isHoogleAvailable(project))
  }
